...
namespace _14597_employes_managment.Controllers
{
    public class InstrumentsController : Controller
    {
        ...
        public async Task<IActionResult> Create(Instruments instrument)
        {
            instrument.CreatedById = "Marco Code";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TipoInstrumento,Instrumento,UsaCordas")] Instruments instrument)
        {
            if (id != instrument.Id)
            {
                return NotFound();
